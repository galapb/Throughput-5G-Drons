...
def generar_df(seed=None, n_usuarios=None):
    ...
    if n_usuarios is None:
        n_usuarios = np.random.randint(20, 30)  # Valor aleatorio si no se especifica
...
tiempo_total = media_tiempo_tx_result 
print("Tiempo Tardaríamos en tx:", tiempo_total/60, "min")


tiempo_dron_a_centroide_izquierda_result = round (tiempo_dron_a_centroide_izquierda_final/15, 2)
tiempo_centroide_izquierda_a_derecha_result= round (tiempo_centroide_izquierda_a_derecha_final/15, 2)
...
print("El valor máximo de 'Tiempo_tx (s)' fue:", suma_nuevos_maximos/max_iteracion)