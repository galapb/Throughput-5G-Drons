...
for i in range(15):
    ...
    df = generar_df(seed=i, n_usuarios=15)
    ...
    if max_iteracion > tiempo_tx_maximo:
        ...
        max_iteracion +=1
    #print(f"SUMA Media del Tiempo_tx: {media_tiempo_tx_final:.2f}")
    ###########################################################################################################################
...
media_tiempo_tx_result = round(media_tiempo_tx_final/60, 4)
print("Tiempo Tardaríamos en tx:", media_tiempo_tx_result, "min")
